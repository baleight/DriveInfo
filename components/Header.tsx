...
export const Header: React.FC<HeaderProps> = ({ noteCount = 0, bookCount = 0 }) => {
  return (
    <header className="w-full border-b-2 border-brut-border bg-brut-bg px-6 lg:px-12 py-5">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        {/* Right: Stats counter */}
        {(noteCount > 0 || bookCount > 0) && (
          <div className="flex items-center gap-2 font-mono text-xs text-brut-muted border-2 border-brut-border px-3 py-1.5 bg-white shadow-brut">
